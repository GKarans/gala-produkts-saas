...
await writeFile(path.join(root,'manifest.json'),JSON.stringify({created_at:new Date().toISOString(),bucket,objects},null,2));console.log(`Backup completed: ${root} (${objects.length} objects).`);
