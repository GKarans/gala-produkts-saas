...
import {FONT_FAMILIES} from '/shared/fonts.js';
...
export function bindCover(surface,value){
 ...
 const draw=()=>{
  surface.dataset.align=pose.align;surface.dataset.font=pose.font;surface.dataset.buttonTheme=pose.buttonTheme;surface.style.setProperty('--guest-title-font',FONT_FAMILIES[pose.font]);surface.style.setProperty('--guest-button',pose.buttonColor);surface.style.setProperty('--guest-button-text',buttonInk(pose.buttonColor));
